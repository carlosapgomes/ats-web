...
- uso do domínio já configurado no provedor SMTP.
...
- usar provedor SMTP via SMTP, sem dependências extras como `django-anymail` neste momento;
...
INTERNAL_APP_BASE_URL=http://web:8000
