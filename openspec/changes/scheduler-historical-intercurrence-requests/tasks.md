...
- [ ] Mensagem histórica do scheduler garante notificação in-app para usuários NIR ativos.
- [ ] Mensagem histórica do scheduler permite menções adicionais a usuários/grupos e preserva/notifica esses destinatários pelo parser existente.
...
- [ ] DRY aplicado: serviço de comunicação e serviços de intercorrência reutilizados; sem duplicar regra de elegibilidade em views.
- [ ] YAGNI aplicado: sem ticket model, sem WebSocket/SSE, sem push/SMS/email operacional, sem busca avançada.
...
Em planejamento. Nenhum slice implementado ainda.
