...
- [ ] Criar e aceitar `docs/adr/ADR-0004-procedimentos-multiplos-e-contrato-llm-neutro.md`, marcando as decisões 1, 2, 3, 5, 6, 8 e 9 da ADR-0003 como parcialmente superadas.

A pré-condição não autoriza implementação. Cada slice ainda exige confirmação explícita após revisão do relatório anterior.
