...
- [ ] Slice 002 — Reforço do prompt canônico LLM1 para resumo narrativo (`slices/slice-002-prompt-llm1-caustico.md`)
...
- [ ] Prompt LLM1 orienta mencionar evento e tempo no resumo narrativo quando disponível.
