# case-work-lock Specification

## Purpose

Define a política de duração (lease) das reservas de caso por contexto de trabalho (`doctor_decision`, `nir_receipt`, `scheduler_confirm`), incluindo precedência entre override explícito, setting por contexto e o setting global. Promovida a partir do change `doctor-decision-lock-lease-1h`.
## Requirements
