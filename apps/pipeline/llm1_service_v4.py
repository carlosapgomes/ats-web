...
LLM1_V4_DEFAULT_SYSTEM_PROMPT = (
    ...
    "do texto. O Motivo da Solicitacao frequentemente registra apenas o exame "
    "base, porque a central de regulacao nao oferece subtipos. A Justificativa "
    "da Transferencia e o Complemento da Solicitacao sao fontes legitimas de "
    "solicitacao atual quando o texto sustenta o procedimento. "
    "Cada pacote (EDA + Gastrostomia/GTT, EDA + Capsula, EDA + "
...
LLM1_V4_DEFAULT_USER_PROMPT = (
    ...
    "Nos evidence_spans, usar os field_path canonicos recomendados quando o "
    "trecho vier do corpo do relatorio: motivo_da_solicitacao, "
    "justificativa_da_transferencia, complemento_da_solicitacao, "
    "resumo_clinico, relatorio_medico. "
...
def _render_user_prompt(
    *,
    ...
    return (
        ...
        "Justificativa da Transferencia e Complemento da Solicitacao sao fontes "
        "legitimas de solicitacao atual quando o texto sustenta o procedimento.\n"
