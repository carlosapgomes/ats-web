"""Slice 003 — CHD agenda procedimento especializado uma única vez (R5/R6).

Cobre o recorte CHD do slice ``slice-003-echoendoscopy-doctor-swap-and-downstream``:

- R5: card/confirmação de Ecoendoscopia autorizada não recebe label de
...
class TestSpecializedSchedulerQueue:
    """Ecoendoscopia autorizada no CHD: badge, agendamento único e comparação."""
